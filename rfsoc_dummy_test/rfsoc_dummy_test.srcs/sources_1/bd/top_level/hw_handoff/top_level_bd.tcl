...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dummy_controller_0_reset [get_bd_pins dummy_controller_0/reset] [get_bd_pins ila_0/probe1] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  connect_bd_net -net dummy_controller_0_t_valid [get_bd_pins dummy_controller_0/t_valid] [get_bd_pins ila_0/probe2] [get_bd_pins usp_rf_data_converter_0/s00_axis_tdata] [get_bd_pins usp_rf_data_converter_0/s00_axis_tvalid]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_pins ila_0/probe3] [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk]
  connect_bd_net -net usp_rf_data_converter_0_s00_axis_tready [get_bd_pins ila_0/probe0] [get_bd_pins usp_rf_data_converter_0/s00_axis_tready]

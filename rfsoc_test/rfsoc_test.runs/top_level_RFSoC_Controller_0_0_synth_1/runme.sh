...
HD_PWD='C:/james/fpga_projects/rfsoc_test/rfsoc_test.runs/top_level_RFSoC_Controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_RFSoC_Controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_RFSoC_Controller_0_0.tcl

...
module top_level
  ...
  wire RFSoC_Controller_0_fire_clk_out;
  ...
  wire [15:0]microblaze_mcs_0_GPIO2_tri_o;
  wire reset_rtl_1;
  ...
  top_level_RFSoC_Controller_0_0 RFSoC_Controller_0
       (.arm(gpio_split_0_arm),
        ...
        .fire_clk_in(util_ds_buf_0_BUFG_O),
        .fire_clk_out(RFSoC_Controller_0_fire_clk_out),
  ...
  top_level_gpio_split_0_0 gpio_split_0
       (.a_tv(gpio_split_0_a_tv),
        ...
        .delay_reg_sclk(gpio_split_0_delay_reg_sclk),
        .fire(gpio_split_0_fire),
        .gpio_in(microblaze_mcs_0_GPIO2_tri_o),
        .idle_reg_data_in(gpio_split_0_idle_reg_data_in),
        .idle_reg_sclk(gpio_split_0_idle_reg_sclk),
        .wave_reg_cycle(gpio_split_0_wave_reg_cycle),
        .wave_reg_data_in(gpio_split_0_wave_reg_data_in),
  ...
  top_level_util_ds_buf_0_0 util_ds_buf_0
       (.BUFG_I(RFSoC_Controller_0_fire_clk_out),

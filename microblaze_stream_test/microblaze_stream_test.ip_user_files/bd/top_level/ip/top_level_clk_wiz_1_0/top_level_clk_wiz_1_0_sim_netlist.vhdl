...
-- Date        : Tue Jun 25 15:55:02 2019
-- Host        : DESKTOP-6ILET8A running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/james/fpga_projects/microblaze_stream_test/microblaze_stream_test.srcs/sources_1/bd/top_level/ip/top_level_clk_wiz_1_0/top_level_clk_wiz_1_0_sim_netlist.vhdl
...
entity top_level_clk_wiz_1_0_top_level_clk_wiz_1_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of top_level_clk_wiz_1_0_top_level_clk_wiz_1_0_clk_wiz : entity is "top_level_clk_wiz_1_0_clk_wiz";
end top_level_clk_wiz_1_0_top_level_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of top_level_clk_wiz_1_0_top_level_clk_wiz_1_0_clk_wiz is
  signal clk_in1_top_level_clk_wiz_1_0 : STD_LOGIC;
  signal clk_out1_top_level_clk_wiz_1_0 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_top_level_clk_wiz_1_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_top_level_clk_wiz_1_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_top_level_clk_wiz_1_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_top_level_clk_wiz_1_0,
...
entity top_level_clk_wiz_1_0 is
  ...
  attribute NotValidForBitStream of top_level_clk_wiz_1_0 : entity is true;
end top_level_clk_wiz_1_0;

architecture STRUCTURE of top_level_clk_wiz_1_0 is
begin
inst: entity work.top_level_clk_wiz_1_0_top_level_clk_wiz_1_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,

...
-- Command     : write_vhdl -force -mode funcsim -rename_top top_level_clk_wiz_1_1 -prefix
--               top_level_clk_wiz_1_1_ top_level_clk_wiz_1_1_sim_netlist.vhdl
-- Design      : top_level_clk_wiz_1_1
...
entity top_level_clk_wiz_1_1_top_level_clk_wiz_1_1_clk_wiz is
  port (
...
end top_level_clk_wiz_1_1_top_level_clk_wiz_1_1_clk_wiz;

architecture STRUCTURE of top_level_clk_wiz_1_1_top_level_clk_wiz_1_1_clk_wiz is
  signal clk_in1_top_level_clk_wiz_1_1 : STD_LOGIC;
  signal clk_out1_top_level_clk_wiz_1_1 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_top_level_clk_wiz_1_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_top_level_clk_wiz_1_1,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_top_level_clk_wiz_1_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_top_level_clk_wiz_1_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_level_clk_wiz_1_1 is
  port (
    clk_out1 : out STD_LOGIC;
    reset : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of top_level_clk_wiz_1_1 : entity is true;
end top_level_clk_wiz_1_1;

architecture STRUCTURE of top_level_clk_wiz_1_1 is
begin
inst: entity work.top_level_clk_wiz_1_1_top_level_clk_wiz_1_1_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,

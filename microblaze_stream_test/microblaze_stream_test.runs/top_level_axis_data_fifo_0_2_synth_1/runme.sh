...
HD_PWD='C:/james/fpga_projects/microblaze_stream_test/microblaze_stream_test.runs/top_level_axis_data_fifo_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_axis_data_fifo_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_axis_data_fifo_0_2.tcl

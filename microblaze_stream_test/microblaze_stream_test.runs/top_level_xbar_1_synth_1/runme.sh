...
HD_PWD='C:/james/fpga_projects/microblaze_stream_test/microblaze_stream_test.runs/top_level_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_xbar_1.tcl

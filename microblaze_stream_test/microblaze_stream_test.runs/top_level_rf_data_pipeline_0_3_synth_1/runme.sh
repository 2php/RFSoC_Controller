...
HD_PWD='C:/james/fpga_projects/microblaze_stream_test/microblaze_stream_test.runs/top_level_rf_data_pipeline_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_rf_data_pipeline_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_rf_data_pipeline_0_3.tcl

...
HD_PWD='C:/fpga_projects/microblaze_uart_test/microblaze_uart_test.runs/top_level_microblaze_mcs_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_microblaze_mcs_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_microblaze_mcs_0_0.tcl

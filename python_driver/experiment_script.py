...
wf0 = rf.WaveFile("2_dc_square_wave.txt", 50*4, 20 + 1.5, 1, 0, 0)
wf1 = rf.WaveFile("2_dc_square_wave.txt", 50*4, 20 + 1.5, 1, 0, 0)
...
c1 = rf.Channel(1, 1, wf_dummy_locking, wf1)
c2 = rf.Channel(2, 1, wf_dummy_locking, wf2)

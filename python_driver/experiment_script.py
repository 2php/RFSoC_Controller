...
wf0 = rf.WaveFile("2_dc_square_wave.txt", 50*4, 0, 1, 0, 0)
wf1 = rf.WaveFile("2_dc_square_wave.txt", 50*4, 2, 1, 0, 0)
wf2 = rf.WaveFile("2_dc_square_wave.txt", 50*4, 20 + 0, 1, 0, 0)
...
c0 = rf.Channel(1, 1, wf_dummy_locking, wf0)
c1 = rf.Channel(4, 1, wf_dummy_locking, wf1)
#c2 = rf.Channel(4, 1, wf_dummy_locking, wf2)

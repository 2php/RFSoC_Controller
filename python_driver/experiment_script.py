...
wf0 = rf.WaveFile("2_dc_square_wave.txt", 50*rf.DAC_WORD_PERIOD, 0)
wf1 = rf.WaveFile("2_dc_square_wave.txt", 50*rf.DAC_WORD_PERIOD, 64*4)
c0 = rf.Channel(0, wf0)
c1 = rf.Channel(1, wf1)
c2 = rf.Channel(2, wf1)

wf_locking = rf.WaveFile("locking_waveform.txt", rf.DAC_WORD_PERIOD, 0)
...
board.set_locking_waveform(wf_locking)

#set the trigger mode
board.set_trigger_mode(rf.TRIGGER_CYCLES)

#set the trigger cycles
board.set_repeat_cycles(200*50)

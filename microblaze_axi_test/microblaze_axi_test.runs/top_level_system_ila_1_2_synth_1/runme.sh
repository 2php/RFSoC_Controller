...
HD_PWD='C:/james/fpga_projects/microblaze_axi_test/microblaze_axi_test.runs/top_level_system_ila_1_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_system_ila_1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_system_ila_1_2.tcl

...
//--------------------------------------------------------------------------------
//Command: generate_target bd_04f1.bd
//Design : bd_04f1
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_04f1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_04f1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "top_level_microblaze_mcs_0_0.hwdef" *) 
module bd_04f1
   (Clk,
    GPIO1_tri_o,
    GPIO2_tri_o,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO1 TRI_O" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME GPIO1, C_GPI1_INTERRUPT 0, C_GPI1_SIZE 32, C_GPO1_INIT 0x00000000, C_GPO1_SIZE 16, C_USE_GPI1 0, C_USE_GPO1 1" *) output [15:0]GPIO1_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO2 TRI_O" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME GPIO2, C_GPI2_INTERRUPT 0, C_GPI2_SIZE 32, C_GPO2_INIT 0x00000000, C_GPO2_SIZE 8, C_USE_GPI2 0, C_USE_GPO2 1" *) output [7:0]GPIO2_tri_o;
  ...
  wire [15:0]iomodule_0_GPIO1_TRI_O;
  wire [7:0]iomodule_0_GPIO2_TRI_O;
  wire iomodule_0_UART_RxD;
  wire iomodule_0_UART_TxD;

  assign Clk1 = Clk;
  assign GPIO1_tri_o[15:0] = iomodule_0_GPIO1_TRI_O;
  assign GPIO2_tri_o[7:0] = iomodule_0_GPIO2_TRI_O;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > bd_04f1 lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_04f1_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_04f1_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_04f1_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_04f1 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_04f1_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk1),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),

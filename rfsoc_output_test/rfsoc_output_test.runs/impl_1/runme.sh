...
HD_PWD='C:/fpga_projects/rfsoc_output_test/rfsoc_output_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_test_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblaze_test_top_wrapper.tcl -notrace

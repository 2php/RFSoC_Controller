...
HD_PWD='C:/fpga_projects/rfsoc_output_test/rfsoc_output_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_test_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_test_top_wrapper.tcl

...
-- Date        : Fri Jun 21 08:11:57 2019
-- Host        : DESKTOP-6ILET8A running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top microblaze_test_top_clk_wiz_0 -prefix
--               microblaze_test_top_clk_wiz_0_ microblaze_test_top_clk_wiz_0_sim_netlist.vhdl
...
entity microblaze_test_top_clk_wiz_0_microblaze_test_top_clk_wiz_0_clk_wiz is
  port (
...
end microblaze_test_top_clk_wiz_0_microblaze_test_top_clk_wiz_0_clk_wiz;

architecture STRUCTURE of microblaze_test_top_clk_wiz_0_microblaze_test_top_clk_wiz_0_clk_wiz is
  signal clk_in1_microblaze_test_top_clk_wiz_0 : STD_LOGIC;
  signal clk_out1_microblaze_test_top_clk_wiz_0 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_microblaze_test_top_clk_wiz_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_microblaze_test_top_clk_wiz_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_microblaze_test_top_clk_wiz_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_microblaze_test_top_clk_wiz_0,
...
entity microblaze_test_top_clk_wiz_0 is
  ...
  attribute NotValidForBitStream of microblaze_test_top_clk_wiz_0 : entity is true;
end microblaze_test_top_clk_wiz_0;

architecture STRUCTURE of microblaze_test_top_clk_wiz_0 is
begin
inst: entity work.microblaze_test_top_clk_wiz_0_microblaze_test_top_clk_wiz_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,

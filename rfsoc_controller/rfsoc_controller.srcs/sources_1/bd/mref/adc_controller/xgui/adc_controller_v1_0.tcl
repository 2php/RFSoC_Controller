...
proc update_PARAM_VALUE.adc_capture_count_sclk { PARAM_VALUE.adc_capture_count_sclk } {
	# Procedure called to update adc_capture_count_sclk when any of the dependent parameters in the arguments change
}

...
void cmd_read_adc()
{
	...
	//free the buffer
	//free(sample_buffer);
	rf_set_adc_shift(old_adc_shift);
}
...
void cmd_load_waveform()
{
	...
	if(uart_receive(waveform_buffer, final_size))
	{
		return;
	}

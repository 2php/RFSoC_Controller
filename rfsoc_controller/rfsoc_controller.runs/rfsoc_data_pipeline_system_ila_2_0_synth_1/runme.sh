...
HD_PWD='C:/james/fpga_projects/rfsoc_controller/rfsoc_controller.runs/rfsoc_data_pipeline_system_ila_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rfsoc_data_pipeline_system_ila_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rfsoc_data_pipeline_system_ila_2_0.tcl

...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache {C:/Users/Marandi Group Vivado/AppData/Roaming/Xilinx/Vivado/.Xil/Vivado-6288-DESKTOP-6ILET8A/incrSyn}
  ...
  add_files -quiet C:/james/fpga_projects/rfsoc_controller/rfsoc_controller.runs/synth_lo_effort/top_level_wrapper.dcp
...
set rc [catch {
  ...
  create_report "impl_lo_effort_place_report_control_sets_0" "report_control_sets -verbose -file top_level_wrapper_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_lo_effort_route_report_power_0" "report_power -file top_level_wrapper_power_routed.rpt -pb top_level_wrapper_power_summary_routed.pb -rpx top_level_wrapper_power_routed.rpx"
  create_report "impl_lo_effort_route_report_route_status_0" "report_route_status -file top_level_wrapper_route_status.rpt -pb top_level_wrapper_route_status.pb"
  create_report "impl_lo_effort_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file top_level_wrapper_timing_summary_routed.rpt -pb top_level_wrapper_timing_summary_routed.pb -rpx top_level_wrapper_timing_summary_routed.rpx"
  create_report "impl_lo_effort_route_report_incremental_reuse_0" "report_incremental_reuse -file top_level_wrapper_incremental_reuse_routed.rpt"
  create_report "impl_lo_effort_route_report_clock_utilization_0" "report_clock_utilization -file top_level_wrapper_clock_utilization_routed.rpt"
  create_report "impl_lo_effort_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file top_level_wrapper_bus_skew_routed.rpt -pb top_level_wrapper_bus_skew_routed.pb -rpx top_level_wrapper_bus_skew_routed.rpx"
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force top_level_wrapper_postroute_physopt.dcp
  create_report "impl_lo_effort_post_route_phys_opt_report_timing_summary_0" "report_timing_summary -max_paths 10 -warn_on_violation -file top_level_wrapper_timing_summary_postroute_physopted.rpt -pb top_level_wrapper_timing_summary_postroute_physopted.pb -rpx top_level_wrapper_timing_summary_postroute_physopted.rpx"
  create_report "impl_lo_effort_post_route_phys_opt_report_bus_skew_0" "report_bus_skew -warn_on_violation -file top_level_wrapper_bus_skew_postroute_physopted.rpt -pb top_level_wrapper_bus_skew_postroute_physopted.pb -rpx top_level_wrapper_bus_skew_postroute_physopted.rpx"

...
EAStep vivado -log top_level_rfsoc_adc_data_captu_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_rfsoc_adc_data_captu_0_0.tcl

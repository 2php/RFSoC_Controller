...
HD_PWD='C:/james/fpga_projects/rfsoc_controller/rfsoc_controller.runs/top_level_trigger_controller_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_trigger_controller_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_trigger_controller_3_0.tcl

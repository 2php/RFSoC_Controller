...
HD_PWD='C:/james/fpga_projects/rfsoc_controller/rfsoc_controller.runs/top_level_rfsoc_data_pipeline_10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_rfsoc_data_pipeline_10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_rfsoc_data_pipeline_10_0.tcl

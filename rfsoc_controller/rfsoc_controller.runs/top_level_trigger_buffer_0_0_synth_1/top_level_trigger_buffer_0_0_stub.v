...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, trigger_in, pipeline_active_in, 
  trigger_out)
/* synthesis syn_black_box black_box_pad_pin="clk,reset,trigger_in,pipeline_active_in,trigger_out" */;
  input clk;
  input reset;
  input trigger_in;

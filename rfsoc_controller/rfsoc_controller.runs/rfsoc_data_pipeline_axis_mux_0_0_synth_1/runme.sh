...
HD_PWD='C:/james/fpga_projects/rfsoc_controller/rfsoc_controller.runs/rfsoc_data_pipeline_axis_mux_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rfsoc_data_pipeline_axis_mux_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rfsoc_data_pipeline_axis_mux_0_0.tcl

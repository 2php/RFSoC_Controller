...
HD_PWD='C:/fpga_projects/board_microblaze_test/board_microblaze_test.runs/top_level_clk_wiz_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_clk_wiz_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_clk_wiz_2.tcl

...
//--------------------------------------------------------------------------------
//Command: generate_target bd_c570.bd
//Design : bd_c570
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_c570,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_c570,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "top_level_microblaze_mcs_0_2.hwdef" *) 
module bd_c570
   (Clk,
    GPIO1_tri_o,
    Reset);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN top_level_clk_wiz_2_clk_out1, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.0" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > bd_c570 lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_c570_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_c570_ilmb_cntlr_0 ilmb_cntlr
       (.BRAM_Addr_A(ilmb_port_ADDR),
        ...
        .Sl_UE(ilmb_sl_0_UE),
        .Sl_Wait(ilmb_sl_0_WAIT));
  bd_c570_iomodule_0_0 iomodule_0
       (.Clk(Clk3),
  ...
  bd_c570_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_c570 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_c570_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk3),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_c570_xlconcat_0_0 xlconcat_0
       (.In0(Dbg_Wakeup),
        .In1(Dbg_Wakeup),
        .dout(Wakeup));
endmodule

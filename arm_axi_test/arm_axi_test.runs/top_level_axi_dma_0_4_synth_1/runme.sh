...
HD_PWD='C:/james/fpga_projects/arm_axi_test/arm_axi_test.runs/top_level_axi_dma_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_axi_dma_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_axi_dma_0_4.tcl

...
HD_PWD='C:/james/fpga_projects/arm_axi_test/arm_axi_test.runs/top_level_zynq_ultra_ps_e_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_zynq_ultra_ps_e_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_zynq_ultra_ps_e_0_2.tcl
